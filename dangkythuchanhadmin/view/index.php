...
?>
<script type="text/javascript" src="http://<?php echo $_SERVER['HTTP_HOST'];?>/qlpmth/dangkythuchanhadmin/js/ajax_dangky.js"></script>
...
<!--Toolbar của datagrid dangky-->
    <div id="tb-khnh" style="padding:2px 5px;">
        <form id="frm_dkphong">
            <div class="fitem" required="true" style="float: left; padding-top: 10px; padding-left: 10px; margin-left: 30px;">
                <select id="cbgdangky"class="easyui-combogrid" style="width:200px;" data-options="
                      rownumbers:'true',
                                ...
                                method: 'get',
                                columns: [[
                                    {field:'tennd',title:'Tên Người dùng',width:120,align:'center'},
            ...
            <div class="fitem" style="float: left; padding-top: 10px; padding-left: 50px;">
                <select id="hocky" class="easyui-combobox" name="hocky" label="Học kì:" labelPosition="top" required="true" style="width:180px;">
                    <option value="HK1">HK1</option>
                    <option value="HK2">HK2</option>
                    <option value="HK3">HK3</option>
                </select>
            </div>
            <div class="fitem" style="float: left; padding-top: 10px; padding-left: 40px;">
                <input name="ngaydangky" class="easyui-datebox" label="Ngày đăng ký:" labelPosition="top" required="true" style="width:190px" id="ngaydangky" data-options="formatter:myformatter,parser:myparser,panelHeight:300" >
            </div>
            <div class="fitem" style="float: left; padding-top: 10px; padding-left: 52px;">
                <input name="ngaytraphong" class="easyui-datebox" label="Ngày trả phòng:" labelPosition="top" required="true" style="width:190px" id="ngaytraphong" data-options="formatter:myformatter,parser:myparser,panelHeight:300" >
            </div> 
            <div class="fitem" style="float: left; padding-bottom: 10px; padding-left: 10px; margin-left: 30px;">
                <input id ="mand" class="easyui-combobox" name="mand" required="true" style="width:200px;" data-options="
                                textField: 'tennd',
                                valueField: 'mand',
            ...
            <div class="fitem" style="float: left; padding-bottom: 10px; padding-left: 50px;">
                <input id ="maphong" class="easyui-combobox" name="maphong" required="true" style="width:180px;" data-options="
                                textField: 'tenphong',
                                valueField: 'maphong',
...
<!--Buttons thêm, xóa, tìm du lieu-->   
        <div class="fitem" style="float: left; padding-left: 40px; padding-top: 20px;">
            <a  onclick="themdk()" class="easyui-linkbutton" data-options=" iconCls:'icon-edit'"> Thêm đăng ký</a>
        </div>
        <div class="fitem" style="float: left; padding-left: 14px; padding-top: 20px;">
            <a onclick="
                ...
                $bien={loai:'timkiemphongtrong', mand:$mand,nienkhoa:$nienkhoa,hocky:$hocky,tu:$tu,den:$den,mamon:$mamon,malophp:$malophp,maphong:$maphong,buoi:$buoi}
                timkiemkethop('ngaydangky','ngaytraphong','dg-khnh1',$bien)
                " class="easyui-linkbutton" style="width: 50px" data-options=" iconCls:'icon-search'">Tìm</a>
        </div>
        <div class="fitem" style="float: left; padding-left: 12px; padding-top: 20px;"> 
            <a onclick="xoadangky()" class="easyui-linkbutton" style="width: 60px" data-options="iconCls:'icon-cancel'">Xóa</a>
        </div>
        <div class="fitem" style="float: left; padding-left: 14px; padding-top: 20px;s"> 
            <a onclick="tailai()" class="easyui-linkbutton" style="width: 70px" data-options="iconCls:'icon-reload'">Tải lại</a>
        </div>
        <div class="fitem" style="float: left; padding-left: 14px; padding-top: 20px;"> 
