...
function kiemtratrung($buoi,$maphong,$hocky,$ngaydangky,$ngaytraphong,$namhoc){
	...
	// kiem tra neu trung nam hoc,hk,nien khoa,buoi,phong va ngảaphong < ngaydangki hoac ngaydk>ngaytra thi return false
	if(mysqli_num_rows($thucthi_kn)==0 or mysqli_num_rows($thucthi) > 0 ){
		...
		//neu khong trung nam hoc,hk,nien khoa,buoi,phong va ngaytraphong < ngaydangki hoac ngaydk>ngaytra thi return true
		return false;
